...
export const EditCombinacionForm = ({ isOpen, setCombinaciones, onClose, combinacion }) => {
            ...
            Alert.fire({
                ...
                preConfirm: async () => {
                    try {
                        ...
                        if (!response.error) {
                            setCombinaciones((combinaciones) => [response.data, ...combinaciones.filter((combinacion)=> combinacion.id !== values.id)])
                            Alert.fire({
                                title: successTitle,
                                text: successMsg,
                                icon: 'success',
    ...
    <Modal
        ...
        <Modal.Header closeButton>
            <Modal.Title>Editar Combinacion</Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default EditCombinacionForm;
